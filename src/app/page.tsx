  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-linear-135 from-blue-950 via-blue-900 to-blue-800 p-8 relative">
      <div className="absolute top-0 right-0 w-full h-full">
        ...
        <div className="absolute top-[45%] left-[40%] w-82 h-82 rounded-full bg-radial from-yellow-400/40 to-transparent blur-3xl animate-pulse-slow animation-2000"></div>
      </div>
      <SignInSignUp />
    </div>
  );
