...
const SignInSignUp = () => {
  ...
  return (
    <div className="@container max-w-md w-full p-8 bg-blue-950/30 rounded-2xl shadow-[0_20px_50px_rgb(0,_29,_61,_0.7)] backdrop-blur-xl border border-blue-800/50 relative animate-fade-in">
      ...
      <div className="relative">
        ...
        <form action="" className="mt-8 space-y-5 perspective-1000">
          {isSignUp && (
            <div className="group">
              <input
                type="text"
          ...
          <button className="group w-full p-4 mt-6 bg-gradient-to-r from-yellow-500 to-yellow-400 text-blue-950 rounded-xl font-bold shadow-lg hover:shadow-yellow-400/40 overflow-hidden transform transform-style-3d hover:-translate-y-0.5 hover:scale-105 hover:translate-z-20 transition-all duration-300 ">
            <span className="relative pointer-events-none z-10">
        ...
        <div className="mt-8 pt-6 border-t border-blue-800/30">
          <p className="text-blue-200/70 text-center text-sm md-4">
            Or continue with
          </p>
          <div className="flex justify-center space-x-6">
            <button className="p-3 bg-blue-500/40 rounded-lg hover:bg-blue-800/50 transition-colors text-yellow-400 hover:text-yellow-300">
